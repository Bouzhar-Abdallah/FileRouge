...
export default function SquadList() {
  ...
  let arrangedPlayers = [];
  arrangedPlayers.push(goalkeepers);
  arrangedPlayers.push(defenders);
  arrangedPlayers.push(midfielders);
  arrangedPlayers.push(forwards);
  console.log(arrangedPlayers);

  return arrangedPlayers.map((players) => (
